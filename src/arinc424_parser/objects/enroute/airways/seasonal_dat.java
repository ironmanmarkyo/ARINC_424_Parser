 ...
 * @author yohan
 */
public class seasonal_dat {
    
    
    public static void SetupTable_seasonal_closure(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'seasonal_closure' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE seasonal_closure" +
...
//            a.close();
    ...
    public static void deleteTable_seasonal_closure(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE seasonal_closure;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_seasonal_closure(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from seasonal_closure;";
    ...
    public static void CleanUpTableDuplicates_seasonal_closure(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "seasonal_closure x " +
                    "USING seasonal_closure y " +
                    "WHERE x.seasonal_closure_icao_identifier = y.seasonal_closure_icao_identifier " +
                    "AND x.ctid < y.ctid;";
            stmt = a.createStatement();
            stmt.executeUpdate(del);
            stmt.close();
