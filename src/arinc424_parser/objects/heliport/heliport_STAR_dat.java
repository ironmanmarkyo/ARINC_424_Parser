 ...
 * @author yohan
 */
public class heliport_STAR_dat {
    public static void SetupTable_heliport_STAR(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'heliport_star' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE heliport_star" +
...
//            a.close();
    ...
    public static void deleteTable_heliport_STAR(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE heliport_STAR;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_heliport_STAR(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from heliport_STAR;";
    ...
    public static void CleanUpTableDuplicates_heliport_STAR(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "heliport_STAR x " +
                    "USING heliport_STAR y " +
