 ...
 * @author yohan
 */
public class heliport_msa_dat {
    
    public static void SetupTable_heliport_msa(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'heliport_msa' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE heliport_msa" +
...
//            a.close();
    ...
    public static void deleteTable_heliport_msa(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE heliport_msa;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_heliport_msa(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from heliport_msa;";
    ...
    public static void CleanUpTableDuplicates_heliport_msa(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "heliport_msa x " +
                    "USING heliport_msa y " +
