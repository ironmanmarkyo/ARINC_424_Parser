 ...
 * @author yohan
 */
public class heliport_SID_dat {
    public static void SetupTable_heliport_SID(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'heliport_sid' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE heliport_sid" +
...
//            a.close();
    ...
    public static void deleteTable_heliport_SID(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE heliport_SID;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_heliport_SID(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from heliport_SID;";
    ...
    public static void CleanUpTableDuplicates_heliport_SID(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "heliport_SID x " +
                    "USING heliport_SID y " +
