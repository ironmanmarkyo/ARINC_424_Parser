 ...
 * @author yohan
 */
public class heliport_waypoint {
    String RecordType;
    String CustomerAreaCode;
    String SectionCode;
    String SubsectionCode;
    String Heliport_Identifier;
    String ICAOCode;
    ...
    public heliport_waypoint(String temp){
        ...
        this.Heliport_Identifier = temp.substring(6,10).trim();
        ...
        this.CalculateLongAndLat_heliport_waypoint();
    }
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    //Calculate locations
    public static void CalculateGeolocations_heliport_waypoint(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "Select exists(select from information_schema.columns where table_name = 'heliport_waypoint' and column_name = 'geolocation');";
...
//                System.out.println("postgis not there");
                String cre = "alter table heliport_waypoint add column geolocation geography(point);";
                stmt.execute(cre);
            }
            String up = "update heliport_waypoint set geolocation = ST_MakePoint(waypoint_longitude, waypoint_latitude);";
...
//            a.close();
    ...
    private void CalculateLongAndLat_heliport_waypoint(){
...
//            System.out.println(latitude);
    ...
    public void InsertDatabase(Connection a){
        ...
        try {
            ...
            String ins = "INSERT INTO heliport_waypoint VALUES(" +
                "\'"+RecordType+"\'" +","+
                "\'"+CustomerAreaCode+"\'" +","+
                "\'"+SectionCode+"\'" +","+
                "\'"+SubsectionCode+"\'"+","+
