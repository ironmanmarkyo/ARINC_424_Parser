...
public class heliport_STAR {
    ...
    public heliport_STAR(String temp){
        ...
        this.STARIdentifier = temp.substring(13,19).trim();
        ...
        this.MultipleCode = temp.substring(111,112).trim();
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public void InsertDatabase(Connection a){
        ...
        try {
            ...
            String ins = "INSERT INTO heliport_star VALUES(" +
                "\'"+RecordType+"\'" +","+
                "\'"+CustomerAreaCode+"\'" +","+
                "\'"+SectionCode+"\'" +","+
                "\'"+HeliportIdentifier+"\'" +","+
