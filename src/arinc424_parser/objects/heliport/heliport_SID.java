...
public class heliport_SID {
    ...
    public heliport_SID(String temp){
        ...
        this.SIDIdentifier = temp.substring(13,19).trim();
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public void InsertDatabase(Connection a){
        ...
        try {
            ...
            String ins = "INSERT INTO heliport_sid VALUES(" +
                "\'"+RecordType+"\'" +","+
                "\'"+CustomerAreaCode+"\'" +","+
                "\'"+SectionCode+"\'" +","+
                "\'"+HeliportIdentifier+"\'" +","+
