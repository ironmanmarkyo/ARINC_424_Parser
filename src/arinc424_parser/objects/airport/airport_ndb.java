...
public class airport_ndb {
    ...
    public airport_ndb() { super(); }
    
    public airport_ndb(String temp){
    ...
    public void InsertDatabase(Connection a){
        ...
        try {
            ...
            String ins = "INSERT INTO airport_ndb VALUES(" +
                "\'"+RecordType+"\'" +","+
                "\'"+CustomerAreaCode+"\'" +","+
                "\'"+SectionCode+"\'" +","+
                "\'"+SubsectionCode+"\'" +","+
...
//                System.out.println(ins);
    ...
    public static void CalculateGeolocations_NDB(Connection a){
        try {
            ...
            String sql = "Select exists(select from information_schema.columns where table_name = 'airport_ndb' and column_name = 'geolocation_ndb');";
...
//                System.out.println("postgis not there");
                String cre = "alter table airport_ndb add column geolocation_ndb geography(point);";
                stmt.execute(cre);
            }
            String up = "update airport_ndb set geolocation_ndb = ST_MakePoint(ndb_longitude, ndb_latitude);";
