 ...
 * @author yohan
 */
public class airport_approach_dat {
    
    public static void SetupTable_airport_approach(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'airport_approach' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE airport_approach" +
...
//            a.close();
    ...
    public static void deleteTable_airport_approach(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE airport_approach;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_airport_approach(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from airport_approach;";
    ...
    public static void CleanUpTableDuplicates_airport_approach(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "airport_approach x " +
                    "USING airport_approach y " +
