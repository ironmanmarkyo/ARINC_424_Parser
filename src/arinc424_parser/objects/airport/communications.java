...
public class communications {
    ...
    public communications(String temp){
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public static void CalculateGeolocations_communications(Connection a){
        try {
            ...
            String sql = "Select exists(select from information_schema.columns where table_name = 'communications' and column_name = 'geolocation');";
...
//                System.out.println("postgis not there");
                String cre = "alter table communications add column geolocation geography(point);";
                stmt.execute(cre);
            }
            String up = "update communications set geolocation = ST_MakePoint(longitude, latitude);";
...
//            System.out.println(latitude);
    ...
    public void InsertDatabase(Connection a){
        ...
        try {
            ...
            String ins = "INSERT INTO communications VALUES(" +
                "\'"+RecordType+"\'" +","+
                "\'"+ CustomerAreaCode+"\'"+","+ 
                "\'"+ SectionCode+"\'"+","+ 
                "\'"+ AirportIdentifier+"\'"+","+ 
