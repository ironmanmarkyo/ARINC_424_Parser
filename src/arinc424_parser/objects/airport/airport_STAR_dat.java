 ...
 * @author yohan
 */
public class airport_STAR_dat {
    public static void SetupTable_airport_STAR(Connection a){
        try {
            Statement stmt = a.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'airport_star' );");
            rs.next();
...
//               System.out.println("true");
                    String sql = "CREATE TABLE airport_star" +
...
//            a.close();
    ...
    public static void deleteTable_airport_STAR(Connection a){
        try {
            Statement stmt = a.createStatement();
            String sql = "DROP TABLE airport_STAR;";
            stmt.executeUpdate(sql);
            stmt.close();
            a.commit();
//            a.close();
    ...
    public static void CleanUpTable_airport_STAR(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE from airport_STAR;";
    ...
    public static void CleanUpTableDuplicates_airport_STAR(Connection a){
        Statement stmt = null;
        try {
            String del = "DELETE FROM " +
                    "airport_STAR x " +
                    "USING airport_STAR y " +
